...
President.create! \
  ...
  term_number: 13,
  biography: "At age 14, Millard learned the cloth-making trade.",
  ended_term_early: false,
  party: "whig",
  former_occupation: "lawyer",
  birth_state_id: State.find_by(name: "New York").id

President.create! \
  name: "Abraham Lincoln",
  term_number: 16,
  biography: "As a young boy, Abe lived in a log cabin.",
  ended_term_early: true,
  party: "republican",
  former_occupation: "lawyer",
  birth_state_id: State.find_by(name: "Kentucky").id

President.create! \
  name: "Harry Truman",
  term_number: 33,
  biography: "During World War I, Truman served in combat in France.",
  ended_term_early: false,
  party: "democrat",
  former_occupation: "clothing retailer",
  birth_state_id: State.find_by(name: "Missouri").id
